...
async def echo(call: CallbackQuery):
    await call.message.answer('''Narxi:15000 ming so'm 
...
@dp.callback_query_handler(text = 'tovuqli')
async def echo(call: CallbackQuery):
    await call.message.answer('''Narxi:17000 ming so'm 
Tarkibi:✅Kulcha,sosiska,ketchup va xantal,qovurilgan piyoz.
...
async def echo(call: CallbackQuery):
    await call.message.answer('''Narxi:8000 ming so'm 
Tarkibi:✅Kulcha,sosiska,ketchup va xantal,qovurilgan piyoz.
...
async def echo(call: CallbackQuery):
    await call.message.answer('''Narxi:28000 ming so'm 
...
Tarkibi:✅Kulcha, mol go'shti, pomidor, sous,  piyoz.
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Cofe 3 v 1 ning narxi 7000!!!!!!: ''',reply_markup = cofe_3_in_1)
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Americano narxi 12000!!!!!!: ''',reply_markup = americano)
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Cappuccino narxi 18000!!!!!!: ''',reply_markup = cappuccino)
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Ko'k choy 3000 so'm !!! ''',reply_markup = qora_choy)
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Limon choy 5000 so'm !!! ''',reply_markup = kuk_choy)
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Qora choy 3000 so'm !!! ''',reply_markup = limon_choy)
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Coca-cola 1.5L 14000 !!! ''',reply_markup = cola)
# Coladan chiqish:
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Fanta 1.5L 14000 !!! ''',reply_markup = fanta)
# Fantadan chiqish:
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Sprite 1.5L 14000 !!! ''',reply_markup = sprite)
# Spritedan chiqish:
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Nestle suvi: 4000 0.5L !!! ''',reply_markup = nestle)
# Nestledan chiqish:
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Nestle suvi: 4000 0.5L !!! ''',reply_markup = bliss)
# Nestledan chiqish:
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Nestle suvi: 4000 0.5L !!! ''',reply_markup = fresh)
# Nestledan chiqish:
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Kartoshka Fri 15 gramm 
        Narxi: 6000 !!! ''',reply_markup = fri)
# Fridan chiqish:
@dp.callback_query_handler(text = 'ortga_59')
async def echo(call: CallbackQuery):
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Kartoshka po Derevenski
        Narxi:6000 ming so'm !!!
Miqdorini tanlang: ''',reply_markup = kartoshka)
...
async def echo(call: CallbackQuery):
    await call.message.answer('''✅Narxi:4000 ming so'm 
